...
<ul id="menu" class="list-group">
	...
	<li class="list-group-item"><a href="#">
		...
		<ul class="in">
			...
			<li name="realAuth"><a href="${pageContext.request.contextPath}/views/realAuth.do">实名认证</a></li>
			<li name="userFile"><a href="${pageContext.request.contextPath}/views/userFile.do">风控资料认证</a></li>
			<li name="bankInfo"><a href="#">银行卡管理</a></li>
			<li name="ipLog"><a href="${pageContext.request.contextPath}/views/ipLog.do">登录记录</a></li>
			<li name="userInfo"><a href="${pageContext.request.contextPath}/views/basicInfo.do"> <span>个人资料</span></a></li>
		</ul>
	</li>
